    ...
    On Error GoTo ErrorHandler
        ...
        End If
            ...
            Select Case summaryType
             Case "Daily"
                targetSheetName = m_sDailySummarySheetName
                targetTableName = m_sDailySummaryTableName
             Case "Weekly"
                targetSheetName = m_sWeeklySummarySheetName
                targetTableName = m_sWeeklySummaryTableName
             Case "Monthly"
                targetSheetName = m_sMonthlySummarySheetName
                targetTableName = m_sMonthlySummaryTableName
             Case Else
            ...
            End If
            sourceDataArr = tblSource.DataBodyRange.Value2
            ...
            For i = 1 To lastRow ' Loop through array rows (1-based)
                ...
                Select Case summaryType
                 ...
                 Case "Monthly" ' add year To the month For uniqueness
